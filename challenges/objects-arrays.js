...
const uni = graduates.filter(x => {
  return (x.university == 'uni');
});
console.log(uni);
...
const lowerCase = zooAnimals.map(x => {
...
*/
const lowerPopulation = zooAnimals.filter(x => {
...
*/
const populationTotal = zooAnimals.reduce((total, x) =>{
